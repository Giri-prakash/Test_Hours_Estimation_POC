...
## Input:
MVA: {transformer_row['MVA']}  
BIL: {transformer_row['BIL']}  
Type: {'Auto' if transformer_row['Auto(Yes/No)'] == 'Yes' else 'Other'}  
Conservator Unit: {'True' if transformer_row['Conservator'] == 'Yes' else 'False'}  
Winding Config: {'TV' if transformer_row['YV/TV Present (Connection_YV or Connection_TV key exists in DB)'] == 'Yes' else 'Other'}  
Test Codes: {'ALL TESTS' if transformer_row['After Test Required (keyword After All Tests exists in DB)'] == 'Yes' else 'None'}  
